...
export type IssuesFromRecentRepos_QueryVariables =
  IssuesFromRecentRepos_Query$variables
export type IssuesFromRecentRepos_Query$data = {
  readonly node: {
    readonly ' $fragmentSpreads': FragmentRefs<'IssuesFromRecentRepos'>
  } | null
}
export type IssuesFromRecentRepos_QueryResponse =
  IssuesFromRecentRepos_Query$data
