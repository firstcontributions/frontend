...
export type IssuesFromLastRepo_Query$variables = {
  count?: number | null;
  cursor?: string | null;
  id: string;
};
export type IssuesFromLastRepo_QueryVariables = IssuesFromLastRepo_Query$variables;
export type IssuesFromLastRepo_Query$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"IssuesFromLastRepo">;
  } | null;
};
export type IssuesFromLastRepo_QueryResponse = IssuesFromLastRepo_Query$data;
export type IssuesFromLastRepo_Query = {
  variables: IssuesFromLastRepo_QueryVariables;
  response: IssuesFromLastRepo_Query$data;
};
